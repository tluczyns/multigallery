...
let EventReceiver = (() => {
	...
	const _bindAll = function() {
		let proto = this;
		while (proto != EventReceiver.prototype) {
	...
	class EventReceiver extends BinderInlineFunctions {
...
class EventReceiverDispatcher extends aggregation(EventReceiver, EventDispatcher) {};

class OptionsControllerMulti {
...
function isElementInsideContainer(elemContainer, elemChild) {
...
function getStyleFromClass(nameClass, elemContainer = undefined) {
...
class MultiRowFlowGallery extends MultiRowCircleGallery {
...
class MultiFlowGallery extends MultiCircleGallery {
